...
if(isset($_POST['btn_login'])){
  ...
  if(is_array($row)){
    ...
    if($row['useremail']==$useremail and $row['userpassword']==$password and $row['role'] == "Admin") {
      ...
      $_SESSION['status']="Login Succes By Admin";
...
$_SESSION['role']=$row['role'];
      ...
      $_SESSION['status']="Login Succes By User";
      $_SESSION['status_code']="success";
...
<head>
  ...
  <title>RHODEL WAYBILL | Log In</title>
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">   
      <a href="../../index2.html"  class="h3"><b>AKWAABA OIL</b> REFINERY</a>
    </div>
    <div class="card-body">
      ...
      <form action="" method="post">
        ...
        <div class="row">
          <div class="col-8">
            ...
            <a href="ui/changepassword.php">I forgot my password</a>
            </div>
          </div>
          <!-- /.col -->
          <div class="col-4">
