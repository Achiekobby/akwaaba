...
// 1) Get value from text feilds and from array in variables.
...
// 2) Write update query tbl_product add stock.
...
$update_tbl_invoice=$pdo->prepare("update tbl_invoice SET order_date=:orderdate,subtotal=:subtotal,discount=:discount,sgst=:sgst,cgst=:cgst,total=:total,payment_type=:payment_type,due=:due,paid=:paid  where invoice_id=:invoice_id=$id"); 
...
//6) Write update query for tbl_product table to updatestock values.
...
<div class="input-group-prepend">
<span class="input-group-text">SUBTOTAL(GHC)</span>
</div>
...
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text">DISCOUNT(GHC)</span>
</div>
...
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text">SGST(GHC)</span>
</div>
...
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text">CGST(GHC)</span>
</div>
...
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text">TOTAL(GHC)</span>
</div>
...
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text">DUE(GHC)</span>
</div>
...
<div class="input-group">
<div class="input-group-prepend">
<span class="input-group-text">PAID(GHC)</span>
</div>
...
$('#saleprice_idd'+data["pid"]).html(saleprice);
...
'<td style="text-align:left; vertical-align:middle; font-size:17px;"><class="form-control product_c" name="product_arr[]" <span class="badge badge-dark">'+product+'</span><input type="hidden" class="form-control product pid" name="pid_arr[]" value="'+pid+'"><input type="hidden" class="form-control product" name="product_arr[]" value="'+product+'"> </td>'+
