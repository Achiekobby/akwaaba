...
if($delete->execute()){
    ...
    $_SESSION['status']="Accounnt Is Not Deleted";
...
<table id="table_registration" class="table table-striped table-hover">
<thead>
<tr>
 <td>#</td>
 <td>Name</td> 
...
<a href="registration.php?id='.$row->userid.'"  class="btn btn-danger"> <i class="fa fa-trash-alt">Delete</i></a>
</td>
